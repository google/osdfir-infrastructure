...
| `config.vertexAPIKey`             | enables the Turbinia LLM Artifacts Analyzer using VertexAI. Please see <https://ai.google.dev/tutorials/setup> to generate your own API key.                                                                         | `""`                                                                                         |
