...
| `config.vertexAPIKey`             | enables the Turbinia LLM Artifacts Analyzer using VertexAI.                                                                                                                                                          | `""`                                                                                         |
| `config.existingVertexSecret`     | Name of existing secret containing Vertex API Key. Must contain key `turbinia-vertexapi`                                                                                                                             | `turbinia-vertexapi-secret`                                                                  |
