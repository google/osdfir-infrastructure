...
| `oauth2proxy.extraEnvVarsSecret`                                   | Name of existing Secret containing extra env vars for OAuth2 Proxy                                                                                                    | `""`                          |
...
| `oauth2proxy.configuration.existingSecret`                         | Secret with the client ID, secret and cookie secret                                                                                                                   | `""`                          |
...
| `oauth2proxy.configuration.cookieSecret`                           | OAuth cookie secret (e.g.  openssl rand -base64 24)                                                                                                                   | `""`                          |
