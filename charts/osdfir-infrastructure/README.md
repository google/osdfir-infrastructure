...
| `global.ingress.openRelikFrontendHost`   | Domain name the OpenRelik UI will be hosted under                                                                                  | `""`    |
| `global.ingress.openRelikAPIHost`        | Domain name the OpenRelik API host will be hosted under                                                                            | `""`    |
